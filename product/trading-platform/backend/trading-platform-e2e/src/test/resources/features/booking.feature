Feature: order booking
  ...
  Scenario: should persist initiation event, then match order, then book order
    # instruments API
    Given instruments
      | id           | price |
      | LU-000000050 | 50    |
    ...
    When clock 2020-03-20T10:10:10.000Z
    And booking event
      | order                                | counterpart                          |
      | 31b79aef-9780-462d-8eea-2d03c3759650 | 8fb8f48b-23c6-4023-bbb5-1395c47aefd8 |
    Then within PT5S, order events
      ...
      | 31b79aef-9780-462d-8eea-2d03c3759650 | 32e7480a-4aef-45ec-bf1a-bc5c49932e9f | LU-000000600 | 10.0     | initiated | 2020-03-20T10:10:00.000Z |
      | 31b79aef-9780-462d-8eea-2d03c3759650 | 32e7480a-4aef-45ec-bf1a-bc5c49932e9f | LU-000000600 | 10.0     | matched   | 2020-03-20T10:10:05.000Z |
      | 31b79aef-9780-462d-8eea-2d03c3759650 | 32e7480a-4aef-45ec-bf1a-bc5c49932e9f | LU-000000600 | 10.0     | booked    | 2020-03-20T10:10:10.000Z |
      | 31b79aef-9780-462d-8eea-2d03c3759650 | 8fb8f48b-23c6-4023-bbb5-1395c47aefd8 | LU-000000600 | -10.0    | booked    | 2020-03-20T10:10:10.000Z |
    And within PT5S, bookings
      | orderId                              | account                              | instrument   | quantity | timestamp                |
      | 31b79aef-9780-462d-8eea-2d03c3759650 | 32e7480a-4aef-45ec-bf1a-bc5c49932e9f | LU-000000600 | 10.0     | 2020-03-20T10:10:10.000Z |
      | 31b79aef-9780-462d-8eea-2d03c3759650 | 8fb8f48b-23c6-4023-bbb5-1395c47aefd8 | LU-000000600 | -10.0    | 2020-03-20T10:10:10.000Z |
    And within PT5S, accounts
      | {"id":"32e7480a-4aef-45ec-bf1a-bc5c49932e9f","owner":"philipp","cash":94000.0,"valuation":100000.0,"assets":[{"instrument":"LU-000000600","price":600.0,"quantity":10.0}]} |
      | {"id":"8fb8f48b-23c6-4023-bbb5-1395c47aefd8","owner":"alice","cash":126000.0,"valuation":135000.0,"assets":[{"instrument":"LU-000000600","price":600.0,"quantity":15.0}]}  |

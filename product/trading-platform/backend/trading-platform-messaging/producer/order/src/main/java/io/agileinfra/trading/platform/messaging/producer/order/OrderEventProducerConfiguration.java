...
@Configuration
public class OrderEventProducerConfiguration {
	@Bean
	public OrderEventProducer orderEventProducer(final JmsTemplate jmsTemplate) {
		return new OrderEventProducer(jmsTemplate);
	}
}
